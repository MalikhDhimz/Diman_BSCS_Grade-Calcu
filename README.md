This Flask app helps students calculate the Midterm and Final grades needed to pass a subject based on their Prelim grade. It checks if passing is possible and provides feedback.
